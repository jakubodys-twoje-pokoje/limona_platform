...
function AdminSidebar({ active, adminImie }: { active: string; adminImie: string }) {
  const links = [
      ...
      <nav className="p-4 space-y-1">
        ...
        <div className="pt-4 border-t border-white/10">
          <Link href="/api/auth/signout"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-[#9B9B9B] hover:bg-white/10">
